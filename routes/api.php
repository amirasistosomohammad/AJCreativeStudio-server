...
Route::get('/products/{id}/thumbnail', [\App\Http\Controllers\ProductImageController::class, 'thumbnail']);
Route::get('/products/{id}/feature/{index}', [\App\Http\Controllers\ProductImageController::class, 'feature']);
